...
const EditCreate = ({ formData, handleChange, handleSubmit, handleImageUpload, imagePreview }) => {
    ...
    return (
        <>
            ...
            >
                ...
                <div className="row justify-content-center justify-content-md-center">
                    <button
                        ...
                        data-bs-target="#editSuccessModal"
                    // onClick={() => router.push()}
                    >
            ...
            <div
                ...
                id="editSuccessModal"
                tabIndex={-1}
                aria-labelledby="editSuccessModalLabel"
                aria-hidden="true"
            >
                <div className="modal-dialog modal-dialog-centered modal-sm">
                    <div className="modal-content border-3 border-primary rounded-0">
                        <div className="modal-body text-bg-dark text-primary">
                            <p className='text-center m-3'>文章修改成功</p>
                        </div>
                    </div>
                </div>
            </div>
